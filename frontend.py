...
def index():
    ...
    url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5001/'
...
def login():
    ...
    if request.method == 'POST':
        ...
        token = token.decode('UTF-8')
        headers = {'access-token': token, 'content-type': 'application/json'}
        url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5002/login'
        response = requests.post(url, data=data, headers=headers)
...
def addToCart(id):
    ...
    url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5003/add-to-cart'
    response = requests.post(url, data=data, headers=headers)
...
def cart():
    ...
    token = token.decode('UTF-8')
    headers = {'access-token': token, 'content-type': 'application/json'}
    url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5003/cart'
...
def placeOrder(cartId):
    ...
    token = token.decode('UTF-8')
    headers = {'access-token': token, 'content-type': 'application/json'} 
    url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5004/place-order'
    data = {"cartId": cartId}
    data = json.dumps(data)
...
def orders():
     ...
     token = token.decode('UTF-8')
     headers = {'access-token': token, 'content-type': 'application/json'}
     url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5003/get-all-cart-id'
     response = requests.post(url, data=data, headers=headers)
     logger.debug("Response from Cart: {}".format(response.status_code))
     if response.status_code is 200:
        data = response.content 
        url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5004/orders'
        response = requests.post(url, data=data, headers=headers)
...
def payment(id):
    ...
    token = token.decode('UTF-8')
    headers = {'access-token': token, 'content-type': 'application/json'}
    url = 'http://edureka-1630729118.us-east-1.elb.amazonaws.com:5005/payment'
